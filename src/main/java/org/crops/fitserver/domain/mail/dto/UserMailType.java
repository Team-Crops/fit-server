...
public enum UserMailType implements MailType {
  CREATE_MATCHING_ROOM("대기방 생성 안내", MailTemplates.CREATE_MATCHING_ROOM_TEMPLATE, "/matching-room"),
  CREATE_MATCHING_ROOM_FOR_HOST("대기방 생성 안내", MailTemplates.CREATE_MATCHING_ROOM_FOR_HOST_TEMPLATE, "/matching-room"),
  DONE_READY_COMPLETE("매칭 준비 완료 안내", MailTemplates.DONE_READY_COMPLETE_TEMPLATE, "/matching-room"),
